const { SQL_SERVER, SQL_DATABASE, SQL_USER, SQL_PASSWORD, SQL_ENCRYPT, CLIENT_ID, AUTHORITY, RETURN_URL, CLIENT_SECRET } = process.env;
...
exports.creds = {
  ...
  // scope: ["profile", "api://77ce5184-fe66-439a-8be8-f6855ce681ea/all"],
...
exports.timesheetDb = {
  ...
  options: {
    encrypt: SQL_ENCRYPT === 'true' ? true : false
  }
}
