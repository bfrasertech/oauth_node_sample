const { AAD_AUTH_ENDPOINT, AAD_TOKEN_ENDPOINT, STATE, AAD_OPEN_ID_CONFIG, OUTBOUNDAAD_CLIENT_ID, OUTBOUNDAAD_CLIENT_SECRET, OUTBOUNDAAD_SCOPES, OUTBOUNDAAD_REDIRECT_URI } = process.env;
